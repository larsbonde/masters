...
def gnn_train(
    ...
    for e in range(epochs):
        ...
        train_loader = torch_geometric.loader.DataLoader(dataset=dataset, batch_sampler=train_sampler, num_workers=4, pin_memory=True)
        valid_loader = torch_geometric.loader.DataLoader(dataset=dataset, batch_sampler=valid_sampler, num_workers=4, pin_memory=True)
