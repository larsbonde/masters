...
dataset = LSTMDataset(
    data_dir=processed_dir / "proteinsolver_embeddings_pos_foldx_repair", 
    annotations_path=processed_dir / "proteinsolver_embeddings_pos_foldx_repair" / "targets.pt"
)
...
esm_ps_dir = processed_dir / "proteinsolver_esm_embeddings_pos_foldx_repair"
