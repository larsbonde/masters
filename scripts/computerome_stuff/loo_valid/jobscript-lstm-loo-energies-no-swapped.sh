...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_lstm_energy_no_swap.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_lstm_energy_no_swap.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_energy_no_swap
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/lstm_loo.py -m energy -s
