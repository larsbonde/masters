...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_lstm_ps_rosetta.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_lstm_ps_rosetta.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_ps_rosetta_no_swapped
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/lstm_loo.py -m ps_rosetta -s
