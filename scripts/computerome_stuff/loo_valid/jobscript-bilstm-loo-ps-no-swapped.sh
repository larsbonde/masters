...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_bilstm_ps.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_bilstm_ps.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N bilstm_ps_no_swap
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/bilstm_loo.py -m ps -s
