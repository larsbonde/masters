...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_loo_cv_fold.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_loo_cv_fold.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_ps_loo_cv_low_clust
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/lstm_loo_inner_cv.py -m ps_foldx -s -c low
