...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_lstm_ps_nested_loo.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_lstm_ps_nested_loo.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_nested_loo_ps_rosetta_no_swap
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/lstm_nested_loo.py -m ps_rosetta -s
