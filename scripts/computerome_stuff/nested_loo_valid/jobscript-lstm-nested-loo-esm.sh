...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_lstm_esm_nested_loo.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_lstm_esm_nested_loo.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_nested_loo_esm
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/lstm_nested_loo.py -m esm
