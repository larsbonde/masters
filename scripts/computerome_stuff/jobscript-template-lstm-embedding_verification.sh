...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_lstm_embedding_verification.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_lstm_embedding_verification.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N lstm_embedding_verification
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/train_lstm_embedding_verification.py
