...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/pos_encode_energy.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/pos_encode_energy.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N pos_encode_energy
###
