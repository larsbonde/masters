...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_err_gnn_foldx.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_run_gnn_foldx.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N ps_finetune_foldx
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/train/train_gnn_early_stop_foldx.py
