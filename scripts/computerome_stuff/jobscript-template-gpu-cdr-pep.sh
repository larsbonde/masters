...
#PBS -e /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_cdr_pep_err.log
#PBS -o /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_cdr_pep_run.log
###
### Job name - not required to be specified
### It is often easier just to use the job id instead for recognition
#PBS -N cdr3_pep_more_reg
###
...
python3 /home/projects/ht3_aim/people/sebdel/masters/scripts/computerome_stuff/train_model_cdr_pep.py
