...
class QuadLSTM(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, num_layers, dropout=0.0):
        ...
        self.batch_norm_in = nn.BatchNorm1d(num_features=embedding_dim)
    ...
    def forward(self, x_1, x_2, x_3, x_4):
        _, (h_1, _) = self.lstm_1(self.batch_norm_in(x_1.permute(0,2,1)).permute(0,2,1))
        _, (h_2, _) = self.lstm_2(self.batch_norm_in(x_2.permute(0,2,1)).permute(0,2,1))
        _, (h_3, _) = self.lstm_3(self.batch_norm_in(x_3.permute(0,2,1)).permute(0,2,1))
        _, (h_4, _) = self.lstm_4(self.batch_norm_in(x_4.permute(0,2,1)).permute(0,2,1)) 
...
out_dir = root / "state_files" / "tcr_binding" / "batch_norm_in"
